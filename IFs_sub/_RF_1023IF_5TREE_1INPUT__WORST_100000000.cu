...
#define _MOD 1024
#define _5TREE
#define EXP_NAME "_RF_1023IF_5TREE_1INPUT__WORST_100000000"

// RF_with_if

__global__ void RF_kernel(float *input, const int n, const int offset0, const int offset1, const int offset2, const int offset3, const int offset4, float *vR)
{
...
if(input[i]>(511+offset4))
{
	if(input[i]>(767+offset4))
{
	if(input[i]>(895+offset4))
{
	if(input[i]>(959+offset4))
{
	if(input[i]>(991+offset4))
{
	if(input[i]>(1007+offset4))
{
	if(input[i]>(1015+offset4))
{
	if(input[i]>(1019+offset4))
{
	if(input[i]>(1021+offset4))
{
	if(input[i]==(1023+offset4))
{
	vR[i] = 1023;
}
else
...
{
	if(input[i]>(1011+offset4))
{
	if(input[i]>(1013+offset4))
{
	if(input[i]==(1015+offset4))
{
	vR[i] = 1015;
...
{
	if(input[i]>(999+offset4))
{
	if(input[i]>(1003+offset4))
{
	if(input[i]>(1005+offset4))
{
	if(input[i]==(1007+offset4))
{
	vR[i] = 1007;
...
{
	if(input[i]>(995+offset4))
{
	if(input[i]>(997+offset4))
{
	if(input[i]==(999+offset4))
{
	vR[i] = 999;
...
{
	if(input[i]>(975+offset4))
{
	if(input[i]>(983+offset4))
{
	if(input[i]>(987+offset4))
{
	if(input[i]>(989+offset4))
{
	if(input[i]==(991+offset4))
{
	vR[i] = 991;
...
{
	if(input[i]>(979+offset4))
{
	if(input[i]>(981+offset4))
{
	if(input[i]==(983+offset4))
{
	vR[i] = 983;
...
{
	if(input[i]>(967+offset4))
{
	if(input[i]>(971+offset4))
{
	if(input[i]>(973+offset4))
{
	if(input[i]==(975+offset4))
{
	vR[i] = 975;
...
{
	if(input[i]>(963+offset4))
{
	if(input[i]>(965+offset4))
{
	if(input[i]==(967+offset4))
{
	vR[i] = 967;
...
{
	if(input[i]>(927+offset4))
{
	if(input[i]>(943+offset4))
{
	if(input[i]>(951+offset4))
{
	if(input[i]>(955+offset4))
{
	if(input[i]>(957+offset4))
{
	if(input[i]==(959+offset4))
{
	vR[i] = 959;
...
{
	if(input[i]>(947+offset4))
{
	if(input[i]>(949+offset4))
{
	if(input[i]==(951+offset4))
{
	vR[i] = 951;
...
{
	if(input[i]>(935+offset4))
{
	if(input[i]>(939+offset4))
{
	if(input[i]>(941+offset4))
{
	if(input[i]==(943+offset4))
{
	vR[i] = 943;
...
{
	if(input[i]>(931+offset4))
{
	if(input[i]>(933+offset4))
{
	if(input[i]==(935+offset4))
{
	vR[i] = 935;
...
{
	if(input[i]>(911+offset4))
{
	if(input[i]>(919+offset4))
{
	if(input[i]>(923+offset4))
{
	if(input[i]>(925+offset4))
{
	if(input[i]==(927+offset4))
{
	vR[i] = 927;
...
{
	if(input[i]>(915+offset4))
{
	if(input[i]>(917+offset4))
{
	if(input[i]==(919+offset4))
{
	vR[i] = 919;
...
{
	if(input[i]>(903+offset4))
{
	if(input[i]>(907+offset4))
{
	if(input[i]>(909+offset4))
{
	if(input[i]==(911+offset4))
{
	vR[i] = 911;
...
{
	if(input[i]>(899+offset4))
{
	if(input[i]>(901+offset4))
{
	if(input[i]==(903+offset4))
{
	vR[i] = 903;
...
{
	if(input[i]>(831+offset4))
{
	if(input[i]>(863+offset4))
{
	if(input[i]>(879+offset4))
{
	if(input[i]>(887+offset4))
{
	if(input[i]>(891+offset4))
{
	if(input[i]>(893+offset4))
{
	if(input[i]==(895+offset4))
{
	vR[i] = 895;
...
{
	if(input[i]>(883+offset4))
{
	if(input[i]>(885+offset4))
{
	if(input[i]==(887+offset4))
{
	vR[i] = 887;
...
{
	if(input[i]>(871+offset4))
{
	if(input[i]>(875+offset4))
{
	if(input[i]>(877+offset4))
{
	if(input[i]==(879+offset4))
{
	vR[i] = 879;
...
{
	if(input[i]>(867+offset4))
{
	if(input[i]>(869+offset4))
{
	if(input[i]==(871+offset4))
{
	vR[i] = 871;
...
{
	if(input[i]>(847+offset4))
{
	if(input[i]>(855+offset4))
{
	if(input[i]>(859+offset4))
{
	if(input[i]>(861+offset4))
{
	if(input[i]==(863+offset4))
{
	vR[i] = 863;
...
{
	if(input[i]>(851+offset4))
{
	if(input[i]>(853+offset4))
{
	if(input[i]==(855+offset4))
{
	vR[i] = 855;
...
{
	if(input[i]>(839+offset4))
{
	if(input[i]>(843+offset4))
{
	if(input[i]>(845+offset4))
{
	if(input[i]==(847+offset4))
{
	vR[i] = 847;
...
{
	if(input[i]>(835+offset4))
{
	if(input[i]>(837+offset4))
{
	if(input[i]==(839+offset4))
{
	vR[i] = 839;
...
{
	if(input[i]>(799+offset4))
{
	if(input[i]>(815+offset4))
{
	if(input[i]>(823+offset4))
{
	if(input[i]>(827+offset4))
{
	if(input[i]>(829+offset4))
{
	if(input[i]==(831+offset4))
{
	vR[i] = 831;
...
{
	if(input[i]>(819+offset4))
{
	if(input[i]>(821+offset4))
{
	if(input[i]==(823+offset4))
{
	vR[i] = 823;
...
{
	if(input[i]>(807+offset4))
{
	if(input[i]>(811+offset4))
{
	if(input[i]>(813+offset4))
{
	if(input[i]==(815+offset4))
{
	vR[i] = 815;
...
{
	if(input[i]>(803+offset4))
{
	if(input[i]>(805+offset4))
{
	if(input[i]==(807+offset4))
{
	vR[i] = 807;
...
{
	if(input[i]>(783+offset4))
{
	if(input[i]>(791+offset4))
{
	if(input[i]>(795+offset4))
{
	if(input[i]>(797+offset4))
{
	if(input[i]==(799+offset4))
{
	vR[i] = 799;
...
{
	if(input[i]>(787+offset4))
{
	if(input[i]>(789+offset4))
{
	if(input[i]==(791+offset4))
{
	vR[i] = 791;
...
{
	if(input[i]>(775+offset4))
{
	if(input[i]>(779+offset4))
{
	if(input[i]>(781+offset4))
{
	if(input[i]==(783+offset4))
{
	vR[i] = 783;
...
{
	if(input[i]>(771+offset4))
{
	if(input[i]>(773+offset4))
{
	if(input[i]==(775+offset4))
{
	vR[i] = 775;
...
{
	if(input[i]>(639+offset4))
{
	if(input[i]>(703+offset4))
{
	if(input[i]>(735+offset4))
{
	if(input[i]>(751+offset4))
{
	if(input[i]>(759+offset4))
{
	if(input[i]>(763+offset4))
{
	if(input[i]>(765+offset4))
{
	if(input[i]==(767+offset4))
{
	vR[i] = 767;
...
{
	if(input[i]>(755+offset4))
{
	if(input[i]>(757+offset4))
{
	if(input[i]==(759+offset4))
{
	vR[i] = 759;
...
{
	if(input[i]>(743+offset4))
{
	if(input[i]>(747+offset4))
{
	if(input[i]>(749+offset4))
{
	if(input[i]==(751+offset4))
{
	vR[i] = 751;
...
{
	if(input[i]>(739+offset4))
{
	if(input[i]>(741+offset4))
{
	if(input[i]==(743+offset4))
{
	vR[i] = 743;
...
{
	if(input[i]>(719+offset4))
{
	if(input[i]>(727+offset4))
{
	if(input[i]>(731+offset4))
{
	if(input[i]>(733+offset4))
{
	if(input[i]==(735+offset4))
{
	vR[i] = 735;
...
{
	if(input[i]>(723+offset4))
{
	if(input[i]>(725+offset4))
{
	if(input[i]==(727+offset4))
{
	vR[i] = 727;
...
{
	if(input[i]>(711+offset4))
{
	if(input[i]>(715+offset4))
{
	if(input[i]>(717+offset4))
{
	if(input[i]==(719+offset4))
{
	vR[i] = 719;
...
{
	if(input[i]>(707+offset4))
{
	if(input[i]>(709+offset4))
{
	if(input[i]==(711+offset4))
{
	vR[i] = 711;
...
{
	if(input[i]>(671+offset4))
{
	if(input[i]>(687+offset4))
{
	if(input[i]>(695+offset4))
{
	if(input[i]>(699+offset4))
{
	if(input[i]>(701+offset4))
{
	if(input[i]==(703+offset4))
{
	vR[i] = 703;
...
{
	if(input[i]>(691+offset4))
{
	if(input[i]>(693+offset4))
{
	if(input[i]==(695+offset4))
{
	vR[i] = 695;
...
{
	if(input[i]>(679+offset4))
{
	if(input[i]>(683+offset4))
{
	if(input[i]>(685+offset4))
{
	if(input[i]==(687+offset4))
{
	vR[i] = 687;
...
{
	if(input[i]>(675+offset4))
{
	if(input[i]>(677+offset4))
{
	if(input[i]==(679+offset4))
{
	vR[i] = 679;
...
{
	if(input[i]>(655+offset4))
{
	if(input[i]>(663+offset4))
{
	if(input[i]>(667+offset4))
{
	if(input[i]>(669+offset4))
{
	if(input[i]==(671+offset4))
{
	vR[i] = 671;
...
{
	if(input[i]>(659+offset4))
{
	if(input[i]>(661+offset4))
{
	if(input[i]==(663+offset4))
{
	vR[i] = 663;
...
{
	if(input[i]>(647+offset4))
{
	if(input[i]>(651+offset4))
{
	if(input[i]>(653+offset4))
{
	if(input[i]==(655+offset4))
{
	vR[i] = 655;
...
{
	if(input[i]>(643+offset4))
{
	if(input[i]>(645+offset4))
{
	if(input[i]==(647+offset4))
{
	vR[i] = 647;
...
{
	if(input[i]>(575+offset4))
{
	if(input[i]>(607+offset4))
{
	if(input[i]>(623+offset4))
{
	if(input[i]>(631+offset4))
{
	if(input[i]>(635+offset4))
{
	if(input[i]>(637+offset4))
{
	if(input[i]==(639+offset4))
{
	vR[i] = 639;
...
{
	if(input[i]>(627+offset4))
{
	if(input[i]>(629+offset4))
{
	if(input[i]==(631+offset4))
{
	vR[i] = 631;
...
{
	if(input[i]>(615+offset4))
{
	if(input[i]>(619+offset4))
{
	if(input[i]>(621+offset4))
{
	if(input[i]==(623+offset4))
{
	vR[i] = 623;
...
{
	if(input[i]>(611+offset4))
{
	if(input[i]>(613+offset4))
{
	if(input[i]==(615+offset4))
{
	vR[i] = 615;
...
{
	if(input[i]>(591+offset4))
{
	if(input[i]>(599+offset4))
{
	if(input[i]>(603+offset4))
{
	if(input[i]>(605+offset4))
{
	if(input[i]==(607+offset4))
{
	vR[i] = 607;
...
{
	if(input[i]>(595+offset4))
{
	if(input[i]>(597+offset4))
{
	if(input[i]==(599+offset4))
{
	vR[i] = 599;
...
{
	if(input[i]>(583+offset4))
{
	if(input[i]>(587+offset4))
{
	if(input[i]>(589+offset4))
{
	if(input[i]==(591+offset4))
{
	vR[i] = 591;
...
{
	if(input[i]>(579+offset4))
{
	if(input[i]>(581+offset4))
{
	if(input[i]==(583+offset4))
{
	vR[i] = 583;
...
{
	if(input[i]>(543+offset4))
{
	if(input[i]>(559+offset4))
{
	if(input[i]>(567+offset4))
{
	if(input[i]>(571+offset4))
{
	if(input[i]>(573+offset4))
{
	if(input[i]==(575+offset4))
{
	vR[i] = 575;
...
{
	if(input[i]>(563+offset4))
{
	if(input[i]>(565+offset4))
{
	if(input[i]==(567+offset4))
{
	vR[i] = 567;
...
{
	if(input[i]>(551+offset4))
{
	if(input[i]>(555+offset4))
{
	if(input[i]>(557+offset4))
{
	if(input[i]==(559+offset4))
{
	vR[i] = 559;
...
{
	if(input[i]>(547+offset4))
{
	if(input[i]>(549+offset4))
{
	if(input[i]==(551+offset4))
{
	vR[i] = 551;
...
{
	if(input[i]>(527+offset4))
{
	if(input[i]>(535+offset4))
{
	if(input[i]>(539+offset4))
{
	if(input[i]>(541+offset4))
{
	if(input[i]==(543+offset4))
{
	vR[i] = 543;
...
{
	if(input[i]>(531+offset4))
{
	if(input[i]>(533+offset4))
{
	if(input[i]==(535+offset4))
{
	vR[i] = 535;
...
{
	if(input[i]>(519+offset4))
{
	if(input[i]>(523+offset4))
{
	if(input[i]>(525+offset4))
{
	if(input[i]==(527+offset4))
{
	vR[i] = 527;
...
{
	if(input[i]>(515+offset4))
{
	if(input[i]>(517+offset4))
{
	if(input[i]==(519+offset4))
{
	vR[i] = 519;
...
{
	if(input[i]>(255+offset4))
{
	if(input[i]>(383+offset4))
{
	if(input[i]>(447+offset4))
{
	if(input[i]>(479+offset4))
{
	if(input[i]>(495+offset4))
{
	if(input[i]>(503+offset4))
{
	if(input[i]>(507+offset4))
{
	if(input[i]>(509+offset4))
{
	if(input[i]==(511+offset4))
{
	vR[i] = 511;
...
{
	if(input[i]>(499+offset4))
{
	if(input[i]>(501+offset4))
{
	if(input[i]==(503+offset4))
{
	vR[i] = 503;
...
{
	if(input[i]>(487+offset4))
{
	if(input[i]>(491+offset4))
{
	if(input[i]>(493+offset4))
{
	if(input[i]==(495+offset4))
{
	vR[i] = 495;
...
{
	if(input[i]>(483+offset4))
{
	if(input[i]>(485+offset4))
{
	if(input[i]==(487+offset4))
{
	vR[i] = 487;
...
{
	if(input[i]>(463+offset4))
{
	if(input[i]>(471+offset4))
{
	if(input[i]>(475+offset4))
{
	if(input[i]>(477+offset4))
{
	if(input[i]==(479+offset4))
{
	vR[i] = 479;
...
{
	if(input[i]>(467+offset4))
{
	if(input[i]>(469+offset4))
{
	if(input[i]==(471+offset4))
{
	vR[i] = 471;
...
{
	if(input[i]>(455+offset4))
{
	if(input[i]>(459+offset4))
{
	if(input[i]>(461+offset4))
{
	if(input[i]==(463+offset4))
{
	vR[i] = 463;
...
{
	if(input[i]>(451+offset4))
{
	if(input[i]>(453+offset4))
{
	if(input[i]==(455+offset4))
{
	vR[i] = 455;
...
{
	if(input[i]>(415+offset4))
{
	if(input[i]>(431+offset4))
{
	if(input[i]>(439+offset4))
{
	if(input[i]>(443+offset4))
{
	if(input[i]>(445+offset4))
{
	if(input[i]==(447+offset4))
{
	vR[i] = 447;
...
{
	if(input[i]>(435+offset4))
{
	if(input[i]>(437+offset4))
{
	if(input[i]==(439+offset4))
{
	vR[i] = 439;
...
{
	if(input[i]>(423+offset4))
{
	if(input[i]>(427+offset4))
{
	if(input[i]>(429+offset4))
{
	if(input[i]==(431+offset4))
{
	vR[i] = 431;
...
{
	if(input[i]>(419+offset4))
{
	if(input[i]>(421+offset4))
{
	if(input[i]==(423+offset4))
{
	vR[i] = 423;
...
{
	if(input[i]>(399+offset4))
{
	if(input[i]>(407+offset4))
{
	if(input[i]>(411+offset4))
{
	if(input[i]>(413+offset4))
{
	if(input[i]==(415+offset4))
{
	vR[i] = 415;
...
{
	if(input[i]>(403+offset4))
{
	if(input[i]>(405+offset4))
{
	if(input[i]==(407+offset4))
{
	vR[i] = 407;
...
{
	if(input[i]>(391+offset4))
{
	if(input[i]>(395+offset4))
{
	if(input[i]>(397+offset4))
{
	if(input[i]==(399+offset4))
{
	vR[i] = 399;
...
{
	if(input[i]>(387+offset4))
{
	if(input[i]>(389+offset4))
{
	if(input[i]==(391+offset4))
{
	vR[i] = 391;
...
{
	if(input[i]>(319+offset4))
{
	if(input[i]>(351+offset4))
{
	if(input[i]>(367+offset4))
{
	if(input[i]>(375+offset4))
{
	if(input[i]>(379+offset4))
{
	if(input[i]>(381+offset4))
{
	if(input[i]==(383+offset4))
{
	vR[i] = 383;
...
{
	if(input[i]>(371+offset4))
{
	if(input[i]>(373+offset4))
{
	if(input[i]==(375+offset4))
{
	vR[i] = 375;
...
{
	if(input[i]>(359+offset4))
{
	if(input[i]>(363+offset4))
{
	if(input[i]>(365+offset4))
{
	if(input[i]==(367+offset4))
{
	vR[i] = 367;
...
{
	if(input[i]>(355+offset4))
{
	if(input[i]>(357+offset4))
{
	if(input[i]==(359+offset4))
{
	vR[i] = 359;
...
{
	if(input[i]>(335+offset4))
{
	if(input[i]>(343+offset4))
{
	if(input[i]>(347+offset4))
{
	if(input[i]>(349+offset4))
{
	if(input[i]==(351+offset4))
{
	vR[i] = 351;
...
{
	if(input[i]>(339+offset4))
{
	if(input[i]>(341+offset4))
{
	if(input[i]==(343+offset4))
{
	vR[i] = 343;
...
{
	if(input[i]>(327+offset4))
{
	if(input[i]>(331+offset4))
{
	if(input[i]>(333+offset4))
{
	if(input[i]==(335+offset4))
{
	vR[i] = 335;
...
{
	if(input[i]>(323+offset4))
{
	if(input[i]>(325+offset4))
{
	if(input[i]==(327+offset4))
{
	vR[i] = 327;
...
{
	if(input[i]>(287+offset4))
{
	if(input[i]>(303+offset4))
{
	if(input[i]>(311+offset4))
{
	if(input[i]>(315+offset4))
{
	if(input[i]>(317+offset4))
{
	if(input[i]==(319+offset4))
{
	vR[i] = 319;
...
{
	if(input[i]>(307+offset4))
{
	if(input[i]>(309+offset4))
{
	if(input[i]==(311+offset4))
{
	vR[i] = 311;
...
{
	if(input[i]>(295+offset4))
{
	if(input[i]>(299+offset4))
{
	if(input[i]>(301+offset4))
{
	if(input[i]==(303+offset4))
{
	vR[i] = 303;
...
{
	if(input[i]>(291+offset4))
{
	if(input[i]>(293+offset4))
{
	if(input[i]==(295+offset4))
{
	vR[i] = 295;
...
{
	if(input[i]>(271+offset4))
{
	if(input[i]>(279+offset4))
{
	if(input[i]>(283+offset4))
{
	if(input[i]>(285+offset4))
{
	if(input[i]==(287+offset4))
{
	vR[i] = 287;
...
{
	if(input[i]>(275+offset4))
{
	if(input[i]>(277+offset4))
{
	if(input[i]==(279+offset4))
{
	vR[i] = 279;
...
{
	if(input[i]>(263+offset4))
{
	if(input[i]>(267+offset4))
{
	if(input[i]>(269+offset4))
{
	if(input[i]==(271+offset4))
{
	vR[i] = 271;
...
{
	if(input[i]>(259+offset4))
{
	if(input[i]>(261+offset4))
{
	if(input[i]==(263+offset4))
{
	vR[i] = 263;
...
{
	if(input[i]>(127+offset4))
{
	if(input[i]>(191+offset4))
{
	if(input[i]>(223+offset4))
{
	if(input[i]>(239+offset4))
{
	if(input[i]>(247+offset4))
{
	if(input[i]>(251+offset4))
{
	if(input[i]>(253+offset4))
{
	if(input[i]==(255+offset4))
{
	vR[i] = 255;
...
{
	if(input[i]>(243+offset4))
{
	if(input[i]>(245+offset4))
{
	if(input[i]==(247+offset4))
{
	vR[i] = 247;
...
{
	if(input[i]>(231+offset4))
{
	if(input[i]>(235+offset4))
{
	if(input[i]>(237+offset4))
{
	if(input[i]==(239+offset4))
{
	vR[i] = 239;
...
{
	if(input[i]>(227+offset4))
{
	if(input[i]>(229+offset4))
{
	if(input[i]==(231+offset4))
{
	vR[i] = 231;
...
{
	if(input[i]>(207+offset4))
{
	if(input[i]>(215+offset4))
{
	if(input[i]>(219+offset4))
{
	if(input[i]>(221+offset4))
{
	if(input[i]==(223+offset4))
{
	vR[i] = 223;
...
{
	if(input[i]>(211+offset4))
{
	if(input[i]>(213+offset4))
{
	if(input[i]==(215+offset4))
{
	vR[i] = 215;
...
{
	if(input[i]>(199+offset4))
{
	if(input[i]>(203+offset4))
{
	if(input[i]>(205+offset4))
{
	if(input[i]==(207+offset4))
{
	vR[i] = 207;
...
{
	if(input[i]>(195+offset4))
{
	if(input[i]>(197+offset4))
{
	if(input[i]==(199+offset4))
{
	vR[i] = 199;
...
{
	if(input[i]>(159+offset4))
{
	if(input[i]>(175+offset4))
{
	if(input[i]>(183+offset4))
{
	if(input[i]>(187+offset4))
{
	if(input[i]>(189+offset4))
{
	if(input[i]==(191+offset4))
{
	vR[i] = 191;
...
{
	if(input[i]>(179+offset4))
{
	if(input[i]>(181+offset4))
{
	if(input[i]==(183+offset4))
{
	vR[i] = 183;
...
{
	if(input[i]>(167+offset4))
{
	if(input[i]>(171+offset4))
{
	if(input[i]>(173+offset4))
{
	if(input[i]==(175+offset4))
{
	vR[i] = 175;
...
{
	if(input[i]>(163+offset4))
{
	if(input[i]>(165+offset4))
{
	if(input[i]==(167+offset4))
{
	vR[i] = 167;
...
{
	if(input[i]>(143+offset4))
{
	if(input[i]>(151+offset4))
{
	if(input[i]>(155+offset4))
{
	if(input[i]>(157+offset4))
{
	if(input[i]==(159+offset4))
{
	vR[i] = 159;
...
{
	if(input[i]>(147+offset4))
{
	if(input[i]>(149+offset4))
{
	if(input[i]==(151+offset4))
{
	vR[i] = 151;
...
{
	if(input[i]>(135+offset4))
{
	if(input[i]>(139+offset4))
{
	if(input[i]>(141+offset4))
{
	if(input[i]==(143+offset4))
{
	vR[i] = 143;
...
{
	if(input[i]>(131+offset4))
{
	if(input[i]>(133+offset4))
{
	if(input[i]==(135+offset4))
{
	vR[i] = 135;
...
{
	if(input[i]>(63+offset4))
{
	if(input[i]>(95+offset4))
{
	if(input[i]>(111+offset4))
{
	if(input[i]>(119+offset4))
{
	if(input[i]>(123+offset4))
{
	if(input[i]>(125+offset4))
{
	if(input[i]==(127+offset4))
{
	vR[i] = 127;
...
{
	if(input[i]>(115+offset4))
{
	if(input[i]>(117+offset4))
{
	if(input[i]==(119+offset4))
{
	vR[i] = 119;
...
{
	if(input[i]>(103+offset4))
{
	if(input[i]>(107+offset4))
{
	if(input[i]>(109+offset4))
{
	if(input[i]==(111+offset4))
{
	vR[i] = 111;
...
{
	if(input[i]>(99+offset4))
{
	if(input[i]>(101+offset4))
{
	if(input[i]==(103+offset4))
{
	vR[i] = 103;
...
{
	if(input[i]>(79+offset4))
{
	if(input[i]>(87+offset4))
{
	if(input[i]>(91+offset4))
{
	if(input[i]>(93+offset4))
{
	if(input[i]==(95+offset4))
{
	vR[i] = 95;
...
{
	if(input[i]>(83+offset4))
{
	if(input[i]>(85+offset4))
{
	if(input[i]==(87+offset4))
{
	vR[i] = 87;
...
{
	if(input[i]>(71+offset4))
{
	if(input[i]>(75+offset4))
{
	if(input[i]>(77+offset4))
{
	if(input[i]==(79+offset4))
{
	vR[i] = 79;
...
{
	if(input[i]>(67+offset4))
{
	if(input[i]>(69+offset4))
{
	if(input[i]==(71+offset4))
{
	vR[i] = 71;
...
{
	if(input[i]>(31+offset4))
{
	if(input[i]>(47+offset4))
{
	if(input[i]>(55+offset4))
{
	if(input[i]>(59+offset4))
{
	if(input[i]>(61+offset4))
{
	if(input[i]==(63+offset4))
{
	vR[i] = 63;
...
{
	if(input[i]>(51+offset4))
{
	if(input[i]>(53+offset4))
{
	if(input[i]==(55+offset4))
{
	vR[i] = 55;
...
{
	if(input[i]>(39+offset4))
{
	if(input[i]>(43+offset4))
{
	if(input[i]>(45+offset4))
{
	if(input[i]==(47+offset4))
{
	vR[i] = 47;
...
{
	if(input[i]>(35+offset4))
{
	if(input[i]>(37+offset4))
{
	if(input[i]==(39+offset4))
{
	vR[i] = 39;
...
{
	if(input[i]>(15+offset4))
{
	if(input[i]>(23+offset4))
{
	if(input[i]>(27+offset4))
{
	if(input[i]>(29+offset4))
{
	if(input[i]==(31+offset4))
{
	vR[i] = 31;
...
{
	if(input[i]>(19+offset4))
{
	if(input[i]>(21+offset4))
{
	if(input[i]==(23+offset4))
{
	vR[i] = 23;
...
{
	if(input[i]>(7+offset4))
{
	if(input[i]>(11+offset4))
{
	if(input[i]>(13+offset4))
{
	if(input[i]==(15+offset4))
{
	vR[i] = 15;
...
{
	if(input[i]>(3+offset4))
{
	if(input[i]>(5+offset4))
{
	if(input[i]==(7+offset4))
{
	vR[i] = 7;
